Ext.define('E4ds.view.accesslog.UaGraph', {
	...
	requires: [ 'Ext.chart.axis.Category', 'Ext.chart.axis.Numeric', 'Ext.chart.series.Bar', 'E4ds.store.AccessLogUserAgents', 'E4ds.store.AccessLogYears' ],
			...
			series: [ {
				...
				tips: {
					...
					renderer: function(storeItem, item) {
						var d = storeItem.get('yearMonth'), percent = storeItem.get(item.storeField) + '%';
