...
public class NavigationService {
	...
	public NavigationService() {
		...
		root.addChild(new MenuNode("Bedarf", null, "BitP.view.bedarf.List", Role.BEDARF,
				Role.EINKAUF));

		root.addChild(new MenuNode("Lieferant", null, "BitP.view.lieferant.List",
				Role.EINKAUF));

		root.addChild(new MenuNode("Anfrage", null, "BitP.view.anfrage.List",
				Role.LIEFERANT));

		root.addChild(new MenuNode("Offerte", null, "BitP.view.offerte.List",
				Role.LIEFERANT));
